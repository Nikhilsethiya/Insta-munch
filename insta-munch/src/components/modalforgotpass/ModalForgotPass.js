...
function ModalForgotPass({ closeModal, email, pass, setSuccessMsg }) {
  ...
  // const sendPassEmail = async (recipientEmail, pass) => {
  //   const apiKey =
  //     "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";
  //   const url = "https://api.sendinblue.com/v3/smtp/email";
  ...
  //         <div style="margin-top: 20px; background-color: #ffffff; overflow: hidden; box-shadow: 0 0 10px rgba(0,0,0,0.1); border-radius: 10px;">
  //           <div style="padding: 20px;">
  //           <p style="font-size: 16px; color: #3b3f44;">Below is your current password consider changing it soon.</p>
  //             <h4 style="font-size: 20px; color: #1f2d3d;">Password :- ${pass}</h4>
  //           </div>
  //         </div>
  //       </div>
  //     </div>`;
