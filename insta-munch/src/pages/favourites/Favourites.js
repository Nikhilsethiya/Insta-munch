...
function Favourites() {
  ...
  const fullObjects = getFullObjects(userFavs, dishFinalData);
  ...
  return isLoading ? (
    ...
    <>
      <Header />
      <div className="md:mx-20 pb-5 border-b-2 pt-28 ">
        <section className="my-8 flex justify-center flex-col  items-center">
          <h1 className="text-3xl font-bold text-center sm:text-4xl mb-10  ">
            Favourites
          </h1>
          {fullObjects && fullObjects.length > 0 ? (
            ...
            <div className="flex items-center justify-center mt-20 w-full">
              <section className="flex items-center  w-full">
                <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
                  ...
                  <p className="text-3xl">No Favorites Yet. Keep Exploring!</p>
                </div>
              </section>
            </div>
          )}
